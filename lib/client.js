...
const student_shared_1 = require("./services/student/student.shared");
/**
 * Returns a typed client for the first-task app.
 *
...
const createClient = (connection, authenticationOptions = {}) => {
    ...
    client.configure(student_shared_1.studentClient);
    return client;
};
